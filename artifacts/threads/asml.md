...
lens: ai
entities: [asml, tsmc, samsung, intel, sk-hynix, mistral-ai]
opened: 2026-08-04
crawled: 2026-08-04
---

# ASML — the EUV Monopoly — timeline

*Watch:* see threads.yaml. Opened 2026-08-04 on a structural-chokepoint
basis, not news volume — ASML is the sole global supplier of EUV
lithography tools; no leading-edge chip (TSMC/Samsung/Intel included)
gets made anywhere without them. Boarded 2026-07-27 as "the board's
biggest absent node"; this crawl gives it its first thread. Backstory
crawl dispatched same day as opening — entries below land
⟨crawl 2026-08-04⟩.
...
## 2026-09-14 — ASML drops 6.2% as Amodei's "pace the frontier" essay reads across into AI-capex fear, dragging the whole chip-equipment chain down with it

- **ASML shares fell 6.2% (to $1,592.89) on 2026-09-14, its sharpest one-day drop since the July China-DUV mass-production scare this thread opened around, after Anthropic CEO Dario Amodei's "We Must Pace the Frontier" essay (published 09-12, calling for coordinated slowdown of frontier AI capability growth) read by markets as a signal that AI capex — and with it demand for the EUV tools this thread exists to track — could soften.** Nvidia fell in parallel (down roughly 3-3.7% premarket the same day) on the same read-across; the S&P 500 and Nasdaq each moved less than half a point, so this was a chip/AI-equipment-specific reaction, not a broad market move. This is a market-pricing event, not a change to ASML's order book, capacity, or the China-DUV/export-control fight this thread otherwise tracks — but it is the first time this thread has recorded the market treating a *safety-pacing* call, rather than a China-substitution or export-control story, as a demand risk to the EUV monopoly itself. ([Motley Fool](https://www.fool.com/investing/2026/09/14/why-asml-stock-is-falling-today/), [TradingKey on NVDA](https://www.tradingkey.com/news/market-movers/262166473-market-movers-nvda-20260914)) ⟨daily 2026-09-14⟩
