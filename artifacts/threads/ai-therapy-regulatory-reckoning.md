...
## 2026-09-22 — A Canadian province sues OpenAI directly over a mass shooting, not a suicide — a new plaintiff type and a new harm type on the same litigation front

- **British Columbia's government — not a victim's family, a provincial Attorney General — filed suit against OpenAI and Sam Altman in federal court in San Francisco on Monday, 2026-09-21, over the February 10, 2026 Tumbler Ridge mass shooting that killed eight people.** The complaint (negligence) alleges ChatGPT's own safety team flagged shooter Jesse Van Rootselaar's conversations about gun violence internally — concerning enough to trigger an internal review — but OpenAI never notified law enforcement; when the company acted, it deactivated the flagged account rather than banning the user, who continued engaging ChatGPT through a second account through the killings. BC Attorney General Niki Sharma says OpenAI has since refused to share the shooter's chat history, and is seeking both damages (to cover emergency-response and community-recovery costs) and a court order forcing OpenAI to overhaul its violence-threat-identification procedures. This is a materially different shape of case than anything else on this thread's docket: a government plaintiff rather than a bereaved family, "failure to warn" rather than product-liability-for-suicide, and a mass-shooting harm rather than self-harm — widening the "litigation, not evidence, is closing the gap" thesis this thread exists to track beyond the JCCP wrongful-death wave (Raine, Garcia, Soelberg, Peralta, Gavalas) into an entirely separate harm category and plaintiff class. ([Al Jazeera](https://www.aljazeera.com/news/2026/9/22/canadas-bc-sues-openai-over-chatgpt-role-in-tumbler-ridge-school-shooting), [CP24](https://www.cp24.com/news/canada/2026/09/22/openai-refused-to-share-tumbler-ridge-shooters-chat-history-bc-attorney-general-says-while-filing-california-lawsuit/), [Bloomberg Law](https://news.bloomberglaw.com/artificial-intelligence/british-columbia-sues-openai-for-failure-to-warn-before-shooting)) ⟨daily 2026-09-22⟩
