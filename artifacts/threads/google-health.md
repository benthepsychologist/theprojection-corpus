---
thread: google-health
title: "Google Health"
lens: mental-health
entities: [google, verily]
opened: 2026-07-24
crawled: 2026-07-24
---

# Google Health — timeline

*Watch:* Google mid-pivot on health — Verily spun OUT to independence (not
wound down); the center of gravity moved to AI (AMIE, a Gemini-powered
...
- **Fitbit rebranded to "Google Health"; the Gemini AI health coach went
  ...
  ([blog.google](https://blog.google)) ⟨crawl 2026-07-24⟩
...
- **Google added mental-health safeguards to Gemini after a wave of AI
  ...
  ([Bloomberg](https://www.bloomberg.com)) ⟨crawl 2026-07-24⟩
...
- **Verily raised $300M and became independent** — Alphabet dropped to a
  ...
  NOT a wind-down.
  ([Fierce Healthcare](https://www.fiercehealthcare.com)) ⟨crawl 2026-07-24⟩
