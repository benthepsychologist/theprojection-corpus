---
thread: where-the-capex-lands
title: "Where the Capex Lands"
lens: ai
entities: [nvidia, openai, spacex, google, meta-ai]
opened: 2026-07-24
---

# Where the Capex Lands — timeline

*Watch:* The ~$750B question as a destination, not a spender — where does
the aggregate AI capex physically land? Chips · datacenters · power · land.
Sibling to Hyperscaler Capex (the by-spender cut); most destinations have no
thread yet — that's the worklist.

## 2026-09-25 — Akamai's Anthropic-deal surge fades to a 3% gain at the close

- **Akamai shares closed up about 3% Friday, a fraction of the 21.3% surge they showed in premarket trading on Thursday's $11.6 billion, seven-year Anthropic cloud-services deal.** CNBC's closing report named Akamai a key winner of the session; the deal, potentially expanding to about $20 billion, carries a warrant for Anthropic to buy up to roughly 5% of Akamai. ([CNBC live updates](https://www.cnbc.com/2026/09/24/stock-market-today-live-updates.html)) ⟨daily 2026-09-25⟩
- **US core capital-goods orders, non-defense excluding aircraft, jumped 1.6% in August against a 0.5% forecast, after July was revised up to +0.6% from unchanged, Reuters reported Friday.** Core orders were up 10.6% from a year earlier, orders for computers rose 1.5% (up 20.1% year on year) and communications equipment 0.3% (up 35.8%), and shipments of core capital goods rose 0.6% after 1.4% in July; economists said the figures point to another quarter of robust business equipment spending amid the AI infrastructure buildout, although the headline durable-goods total was flat. ([Reuters, via Lufkin Daily News](https://lufkindailynews.com/news_reuters/business/us-core-capital-goods-orders-point-to-robust-growth-in-business-spending-on-equipment/article_ebd6db4c-a082-5063-a667-ac92f72a6480.html), [U.S. Census Bureau](https://www.census.gov/manufacturing/m3/adv/pdf/durgd.pdf)) ⟨daily 2026-09-25⟩
...
- 💡 **This is the gap made concrete, not just structural:** the 08-03
  ...
  `datacenter-power-grid` child thread). Two different grids, same
  ...
  reasons unrelated to power availability at all. ⟨daily 2026-08-05⟩
...
- 💡 **Meta-thread read:** this thread maps capex flowing down into compute,
  ...
  node for that gap yet. ⟨daily 2026-08-03⟩
...
- **Opened as the destination cut of AI capex** (ben-steer) — gathers the
  ...
  sites) as the collection worklist. ⟨steer 2026-07-24⟩
