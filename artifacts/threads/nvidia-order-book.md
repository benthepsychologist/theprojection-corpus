---
thread: nvidia-order-book
title: "Nvidia's Order Book"
lens: ai
entities: [nvidia, openai, meta-ai]
opened: 2026-07-24
crawled: 2026-07-24
---

# Nvidia's Order Book — timeline

*Watch:* The demand side of the chip spend — the reported ~$1T Blackwell+Rubin
...
- **Nvidia's own 8-K puts the total deal value at $12.93bn ($11.9bn to stockholders + up to $1.0bn employee retention) — resolving this thread's 08-26 "agreed" report and its 09-01 update, and correcting the ~$14bn total the 09-01 entry carried.** The 09-01 entry (sourced to Bloomberg) read the reported $12.9B figure as the base price with a rumored $1B retention package layered on top, putting the total at "~$14B." The primary filing shows the two instruments actually sum to $12.93bn, not ~$14bn — the earlier escalation did not hold up against Nvidia's own disclosed structure. See the correction below.
  ([SEC EDGAR 8-K](https://www.sec.gov/Archives/edgar/data/1045810/000104581026000078/nvda-20260902.htm), [TechCrunch](https://techcrunch.com/2026/09/03/nvidia-confirms-it-will-buy-hugging-face-for-12-9-billion/)) ⟨daily 2026-09-03⟩
...
- **Nvidia guided Q3 FY2027 revenue to $108.0bn, plus or minus 2%**, per its own release, on top of **$96.2bn of actual Q2 FY2027 revenue, up 106% year over year**. The stock closed **+8.74% at $227.98**. ⚠️ **The widely-quoted $104.2bn "consensus" is a media-reported analyst aggregate, not an Nvidia figure**, and the two should not be set against each other as if they came from the same kind of source. This entry also settles the prior day's hedge: the map could only say "roughly 7-8%" live, and the close is now on the record.
  ([Nvidia investor relations](https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-Announces-Financial-Results-for-Second-Quarter-Fiscal-2027)) ⟨daily 2026-08-27⟩
...
- **Bloomberg reported at 20:56 ET that Nvidia is in talks to buy Hugging Face
  ...
  ⟨daily 2026-08-26⟩
- **Nvidia CFO Colette Kress told analysts on the 08-26 earnings call that demand from the AI labs Nvidia supports with its own balance sheet will contribute toward roughly a quarter of its business next year, and that Nvidia has put nearly $50 billion into the frontier labs that buy its chips.** Kress acknowledged that some would call the arrangement circular financing, and said Nvidia sees it differently. She also named the financing partners (Apollo, BlackRock, Blackstone, Brookfield, Goldman Sachs, KKR) for platforms meant to raise more than $500 billion of outside capital, and said the first phase of a site secured with SB Energy supports 4.25 gigawatts for OpenAI, whose existing and planned commitments she put at about 12 gigawatts of Nvidia compute through 2030. This turns this thread's circular-financing question into a stated share of demand: a management-quantified fraction of the order book depends on customers Nvidia is funding, on top of the $105bn of guarantees and the receivables concentration already logged from the 10-Q the same day. ([AI News](https://www.artificialintelligence-news.com/news/nvidia-circular-financing-ai-labs/)) ⟨daily 2026-09-23⟩
