---
thread: allianz-ai-claims-automation
title: "Allianz AI Claims"
lens: ai
entities: [allianz, anthropic]
opened: 2026-08-04
crawled: 2026-08-04
---

# Allianz AI claims automation — timeline

*Watch:* Allianz went from Solvency-II-constrained capital pool to the
#1-ranked insurer on the 2026 Evident AI Index, backed by a live agentic
claims system (Project Nemo, ~80% faster on small claims in Australia) and
a named global partnership with Anthropic (Claude free to all employees,
Claude Code already in developer use, co-developed agentic claims AI for
motor/health). Track: whether Project Nemo or the Anthropic-built claims
agents expand beyond their initial scope/geography, and whether any
EU/Solvency-II regulatory response to agentic claims AI emerges.
...
- **Opened following a board-pass audit that found the entire insurance
  ...
  companies this crawl was told to prioritize (Ping An and Berkshire were),
  but the evidence didn't support leaving it out — it turned out to be one
  of the strongest, most concretely-sourced stories of the whole pocket.
- **Allianz ranked #1 in the 2026 Evident AI Index for Insurance**, ahead
...
- **A formal global partnership with Anthropic, announced 2026-01-09** —
  ...
  group-wide; Claude Code is already in use by "thousands" of Allianz
  developers; Allianz and Anthropic will co-develop agentic AI for motor
