...
- **DOL's Employee Benefits Security Administration published an "Interim Enforcement Roadmap" for MHPAEA, with EBSA Assistant Secretary Daniel Aronowitz signaling more aggressive enforcement of the parity law's nonquantitative-treatment-limitation (NQTL) requirements while the administration's full replacement rule remains pending (NPRM still expected end of 2026).** Confirmed genuinely new and dated, not a re-serve, via a second trade outlet (Behavioral Healthcare Network) carrying the same story same-day. This is precisely what this thread's own watch line names — enforcement-gap consequences arriving while the NPRM itself has not moved. ⚠️ Published 2026-09-08 8:27 PM UTC (4:27 PM ET), about 87 minutes after the 09-08 digest's 15:00 ET `as_of` cutoff — a window-boundary timing issue caught by the coverage critic and folded in here at finalize, not a same-day curation miss. ⟨daily 2026-09-08⟩
...
- **The administration announced it will propose a REPLACEMENT for the
  ...
  with a reported "by end of year" target (thin, single source). The
  operative fact: no payer compliance deadline currently exists; parity
  is a rule-making vacuum, not a countdown.
