---
thread: bigtech-into-health
title: "Big Tech into Health"
lens: mental-health
entities: [microsoft, google, apple, amazon-aws, openai]
opened: 2026-07-24
---

# Big Tech into Health — timeline
...
- **Apple used its September 9 hardware keynote to unveil a redesigned Health app — Apple Intelligence-powered "Health Age" and a daily "Readiness Score," an Insights tab, camera-assisted movement assessments aimed at older users and injury recovery, a Longevity tab, and a $119 Quest Diagnostics 50-biomarker panel — rolling out "later this year" starting in U.S. English.** This is the same "real vs. announced" test this meta-thread has now run on three giants in six weeks: Google's Pixel Watch 5 event (08-15, logged here) shipped hardware with no new MH feature; Apple's event is the same shape again, one tier up — a full Health-app overhaul, genuinely shipping, Apple-Intelligence-branded, and entirely physical-health-coded (cardio, sleep, movement, biomarkers). Apple's own existing mood log ("State of Mind") and PHQ-9/GAD-7 depression/anxiety self-assessments — both shipped years before this thread opened — were not mentioned as part of the redesign in the keynote coverage reviewed, and no new MH-specific capability accompanied the announcement. Apple's AI health coach, previously expected at WWDC 2026, was reportedly held back and did not appear at this event either. ⚠️ Availability is "later this year" with no fixed date — a real product commitment, not yet a shipped one.
  ([TechCrunch](https://techcrunch.com/2026/09/09/apples-revamped-health-app-will-calculate-your-health-age-and-readiness-score/)) ⟨daily 2026-09-14⟩
...
- **OpenAI's ChatGPT Health went GA to all US users 18+** (07-23),
  linking Apple Health data — the same week as a wave of suicide/
  psychosis-reinforcement suits and a 42-state AG probe of the general
  model. Reads as the evidence-gap thesis in miniature: a frontier lab
  building a formal "health" layer precisely because unmanaged de-facto
  health use (>1M/week suicidal-planning signals on the general model)
