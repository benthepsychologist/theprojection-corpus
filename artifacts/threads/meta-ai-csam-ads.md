...
- **As of today, the date this thread's own ledger set as the grace-period expiry, Meta still has not responded to Senator Warner's letter and Warner's office has still said nothing about the non-response — eleven days past the original 08-18 letter, three past the 08-26 deadline it set.** Checked directly against both primary sources again: Warner's Senate press-releases page carries nothing about Meta between 08-26 and 08-29 (its most recent posts are on Israeli settlements and an affordability-crisis data release); Meta's newsroom has nothing past its 08-26 teen-safety-agreement post and a data-center cooling explainer. No FTC action, no state AG inquiry, and no other senator joining Warner was found. **This closes the map's own watch item as a confirmed negative, not an unresolved wait** — worth a decision on whether to keep tracking this specific letter or mark it closed/escalate the "no response" itself as the story.
  ([Warner's Senate press releases](https://www.warner.senate.gov/public/index.cfm/press-releases), [Meta Newsroom](https://about.fb.com/news/)) ⟨daily 2026-08-29⟩
...
- **Sen. Mark Warner (D-VA) sent a formal letter to Meta CEO Mark
  ...
  ([Sen. Warner, primary](https://www.warner.senate.gov/newsroom/press-releases/warner-presses-meta-ceo-on-ads-featuring-child-sexual-abuse-material-and-non-consensual-intimate-images/)) ⟨daily 2026-08-20⟩
- **The letter cites new scope from the Tech Transparency Project, not
  ...
  ([MLex](https://www.mlex.com/mlex/data-privacy-security/articles/2514848)) ⟨daily 2026-08-20⟩
...
- **A New Mexico judge (Bryan Biedscheid) ordered Meta to pay $567M into a
  child mental-health abatement fund, calling the company a "public
  nuisance,"** in NM Attorney General Raúl Torrez's algorithmic-design
  suit (filed 2023) — on top of the $375M in civil penalties a jury
  ordered against Meta in March 2026 after finding it knowingly harmed
  children's mental health and concealed what it knew about child sexual
  exploitation on its platforms. This is a different case and a
  different mechanism than the Wired ad-platform story that opened this
  thread (design/engagement harm vs. AI-generated CSAM in paid ads), but
  the March jury's CSAM-concealment finding underpins both, so it's
  logged here rather than split into a new thread. Ruling landed evening
  of 2026-08-06 ET, ahead of the 2026-08-07 digest window; dated
  explicitly rather than presented as breaking today.
  ([CNBC](https://www.cnbc.com/2026/08/06/meta-to-pay-into-567-million-fund-after-child-harms-case-new-mexico.html), [PBS NewsHour](https://www.pbs.org/newshour/nation/new-mexico-court-orders-meta-to-pay-567-million-over-mental-health-harms-to-kids-online)) ⟨daily 2026-08-07⟩

## 2026-08-06 — Opened (ben-steer)

- **Meta ran ads containing AI-generated child sexual abuse imagery**, per
  a Wired investigation — no thread on this map previously tracked
  platform/ad-system liability for AI-generated CSAM (the existing
  companion-chatbot harm thread is scoped to xAI/Grok, a different
  mechanism). Offered as a thread candidate by the AI-lens fresh-story
  sweep the same day; promoted same-session ("track the Meta CSAM ads...
  thread, good one").
  ([Wired](https://www.wired.com/story/meta-ran-ads-that-contained-ai-generated-child-sexual-abuse-imagery/)) ⟨steer 2026-08-06⟩
