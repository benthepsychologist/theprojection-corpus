...
- **Brent's Friday 09-04 settlement was $96.28, not the $92.68 this map carried from the 09-04 run through today — a digit transposition that reached four digests, this thread, an interpretation sidecar and the public site.** The percentages recorded alongside the level were always the disproof and were never checked against it: +0.8% on the day and +7.6-7.8% on the week reconcile with $96.28 (09-03 settle $95.52, 08-28 settle $89.31) and would be -3.0% and +3.8% from $92.68. Worse, when the map's own secondary sources reported $95-97 on 09-03 and 09-04, a note was written declaring the transposed settlement authoritative and dismissing those correct reads as "intraday or contract-mismatched." WTI's $91.48 and +10% week were transcribed correctly throughout, so only the Brent level was affected. Verified against two independent instruments this run. ⟨daily 2026-09-07⟩
