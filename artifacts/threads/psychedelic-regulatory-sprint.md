---
thread: psychedelic-regulatory-sprint
title: "Psychedelic Sprint"
lens: mental-health
entities: []
opened: 2026-08-07
---

# Psychedelic Sprint — timeline

*Watch:* Psilocybin racing toward first-ever US approval (Compass NDA
targeted Q4 2026, National Priority Vouchers compressing review to 1-2
months, an April 2026 executive order behind it) — 18 months after FDA
rejected MDMA on unblinding/safety grounds and then wrote new trial-design
...
- **Transcend Therapeutics registered EMPOWER-2, a second 300-patient Phase 3 of TSND-201, its methylone-derived drug for PTSD, with primary completion estimated February 2028.** The design mirrors EMPOWER-1 (weekly dosing for four weeks at one of two dose levels or placebo, an eight-week follow-up, CAPS-5 as primary outcome; primary completion estimated December 2027); EMPOWER-2 lists two US sites so far against 37 for EMPOWER-1. Sponsor-registered design only, no data. ([ClinicalTrials.gov NCT07836647](https://clinicaltrials.gov/study/NCT07836647), [EMPOWER-1 record](https://clinicaltrials.gov/study/NCT07456696)) ⟨daily 2026-09-23⟩
- **The US Drug Enforcement Administration proposed on 09-23 placing five tryptamine hallucinogens (4-OH-DiPT, 5-MeO-AMT, 5-MeO-MiPT, 5-MeO-DET and DiPT) in Schedule I.** Comments are open until 10-23; if finalized the rule would apply Schedule I controls to manufacturing, distributing, importing, researching or possessing the five compounds. ([Federal Register](https://www.federalregister.gov/documents/2026/09/23/2026-19400/schedules-of-controlled-substances-placement-of-4-hydroxy-nn-diisopropyltryptamine-4-oh-dipt)) ⟨daily 2026-09-23⟩
- **Portland's City Council advanced an ordinance on 09-23 that would make personal, noncommercial use of naturally occurring psychedelics one of the city's lowest law-enforcement priorities, with a second reading set for 09-30.** It would also create a Portland Psychedelics Advisory Commission for harm reduction and public education at what city officials called minimal cost, while police keep investigating illegal sales and impaired driving; co-sponsor Elana Pirtle-Guiney said it aligns city code with current enforcement practice for substances such as psilocybin mushrooms and mescaline, and KPTV reports it follows similar measures in Seattle, San Francisco, Denver and Washington, D.C. A city ordinance only, and not final until the 09-30 vote. ([KPTV](https://www.kptv.com/2026/09/24/portland-considers-deprioritizing-psychedelics/), [KXL](https://www.kxl.com/portland-city-councilors-advancing-ordinance-adding-psychedelic-health-and-safety-chapter-to-city-code/)) ⟨daily 2026-09-24⟩
...
- **Oregon's Health Authority said on 09-22 it will not adopt rules that would have doubled annual license fees for the state's legal psilocybin businesses and ended veteran and low-income discounts, and will open a new rulemaking, planned to take effect 01-15-2027.** Records released under a public-records request projected a $3.8 million shortfall in the program's current two-year budget without the increase, and $2.9 million to $4.2 million with it depending on how many licensees quit; the authority is weighing a higher tax on psilocybin products, and every speaker at two public hearings opposed the fees. ([Oregon Health Authority bulletin](https://content.govdelivery.com/accounts/ORHA/bulletins/42bf6f3), [Oregon Capital Chronicle](https://oregoncapitalchronicle.com/2026/09/23/oregon-regulators-nix-higher-fees-for-psilocybin-after-industry-backlash/)) ⟨daily 2026-09-22⟩
...
- **COMPASS Pathways told the Morgan Stanley 24th Annual Global Healthcare Conference (09-16) it is on track for a possible first-half-2027 launch for COMP360, its psilocybin depression drug, with the FDA's rolling priority review continuing toward a Q4-2026 final NDA submission.** No new trial data — the six-month Phase 3 durability figures already on this thread from July stand (remission 30-50%, response 40-50% in open-label follow-up) — but management spelled out the expected label for the first time in concrete terms: two initial doses minimum three weeks apart, then maintenance redosing "two to four times annually," against Spravato's 25-52 annual visits. That dosing contrast is the clearest read yet on how COMPASS is positioning against the market's one existing rapid-acting option.
  ([Investing.com conference transcript](https://www.investing.com/news/transcripts/compass-pathways-at-morgan-stanley-conference-launch-data-and-fda-push-93CH-4904159)) ⟨daily 2026-09-16⟩
...
- **Definium Therapeutics announced its LSD-derived DT120 met the primary endpoint in Panorama, a second Phase 3 trial in generalized anxiety disorder, on the same day as the FDA's own psychedelics hearing.** In the 12-week trial, the 100-microgram dose produced a 9.8-point drop on the Hamilton Anxiety Rating Scale versus 4.7 for placebo — a 5.1-point placebo-adjusted improvement, close to the 5.4-point gap this thread already logged from August's Voyage trial (the drug's first GAD readout). This is Definium's third positive Phase 3 for DT120 overall, following June's MDD win (Emerge) and August's first GAD win (Voyage) — the two-trials-per-indication requirement the FDA typically wants for approval is now met in anxiety specifically, not just claimed once. ⚠️ Topline, sponsor-reported figures from a company release; no independent read or peer-reviewed publication yet, consistent with every other Definium readout on this thread.
  ([STAT](https://www.statnews.com/2026/09/14/definiums-lsd-therapy-eased-anxiety-large-trial-psychedelic/), [BioSpace](https://www.biospace.com/drug-development/definiums-lsd-based-therapy-elicits-profound-efficacy-in-phase-3-depression-trial)) ⟨daily 2026-09-15⟩
...
- **FDA officials, including authors Davis and Farchione, published a commentary in NEJM restating the agency's psychedelic regulatory framework — Breakthrough Therapy designations and refinements to the 2023 draft guidance.** The load-bearing detail: the commentary states Compass Pathways' rolling review is "expected to complete next quarter" — a completion timetable stated by FDA authors themselves, firmer than the sponsor-side guidance this thread has carried so far. ⚠️ **Single-sourced: the NEJM article itself could not be reached in this pass; this rests on a secondary summary.** Published 2026-09-09, with first press pickup 2026-09-10 12:04 ET. ([Psychedelic Alpha](https://psychedelicalpha.com/news/fda-officials-nejm-commentary-psychedelics)) ⟨daily 2026-09-10⟩

## 2026-09-09 — Compass Pathways posts 52-week durability data for its psilocybin depression drug

- **Compass Pathways reported 52-week topline open-label data from its Phase 3 COMP005 trial of COMP360 (psilocybin) for treatment-resistant depression: patients originally dosed at 25mg who received an additional open-label dose in Part C (weeks 26-52) showed an average 13-point reduction in MADRS depression scores from baseline at week 52, while placebo-arm patients getting their first 25mg dose in Part C showed a 10-point reduction.** About 70% of the 258-participant trial continued into Part C, and roughly 80% of the 25mg arm that entered it took the additional dose. The company's rolling FDA submission continues toward a Q4-2026 final NDA, with a possible launch in the first half of 2027. This is a new, later durability readout than the six-month figures already on this thread, bearing directly on the confirmatory-evidence question the map is tracking in parallel on the neuromodulation thread (trial-to-real-world durability gap). ([Compass Pathways IR](https://ir.compasspathways.com/News--Events-/news/news-details/2026/Compass-Pathways-New-52-Week-Topline-Open-Label-Data-from-Phase-3-COMP005-Trial-Demonstrates-Additional-Benefit-from-Another-COMP360-Dose-in-Part-C-Extending-Durability-Out-to-1-Year/default.aspx)) ⟨daily 2026-09-21⟩
...
- **The VA disclosed it's now running its 20th active clinical trial of
  ...
  academic.
  ([Behavioral Health Business](https://bhbusiness.com/2026/08/14/the-va-is-now-evaluating-mdma-glp-1s-and-psilocybin-for-behavioral-health/), [NCT07765693](https://clinicaltrials.gov/study/NCT07765693)) ⟨daily 2026-08-14⟩
...
- **Definium's LSD-based DT120 hit its primary endpoint in a Phase 3
  ...
  digest.
  ([STAT News](https://www.statnews.com/2026/08/12/definium-lsd-treatment-anxiety-study/), [Fierce Biotech](https://www.fiercebiotech.com/biotech/definium-hits-another-ph-3-homerun-psychedelic-sea-change-anxiety)) ⟨daily 2026-08-12⟩

## 2026-08-10 — Resilient Pharmaceuticals quietly resubmitted its MDMA NDA for PTSD without a new Phase 3 trial

- **Resilient Pharmaceuticals — the renamed Lykos Therapeutics — resubmitted its new drug application for MDMA-assisted therapy for PTSD to the FDA in the second week of August 2026, almost exactly two years after the FDA's Complete Response Letter of 2024-08-09, and did so without running a new Phase 3 study.** Resilient has not publicly discussed the filing; the resubmission was first reported by Psychedelic Alpha from sources familiar with it, and MAPS — which incubated the company and funded the underlying trials — responded to that report in its own 08-10 statement, which is the date used here. Instead the resubmission leans on third-party and VA data plus a new Phase I safety trial in 32 healthy volunteers to address the CRL's three cited gaps — durability, adverse-event characterization, and unblinding/bias mitigation. MAPS, which incubated the original public-benefit company and funded the 2022 trials underlying the application, said in its own statement that it "has no active role in Resilient's drug development program" going forward. This directly answers the thread's standing question — whether approval is outrunning the methodology fix the FDA wrote after the MDMA rejection — with FDA review of a resubmitted, not newly-generated, evidence package. Psychedelic Alpha reads the resubmission package as the CRL's three gaps answered by a small VA long-term-follow-up study, at least one other third-party dataset, a 32-subject Phase I safety study and an audit of the Phase 3 data — and expects a resubmission review to run faster than a new one, which puts Resilient in a race with the psilocybin sponsors holding priority vouchers for the first US psychedelic approval decision. ([MAPS](https://maps.org/2026/08/10/maps-responds-to-report-of-progress-for-mdma-assisted-therapy-for-ptsd-with-fda/), [Psychedelic Alpha](https://psychedelicalpha.com/news/two-years-after-rejection-resilient-quietly-refiles-mdma-for-ptsd-application/), [Psychedelics Today](https://psychedelicstoday.com/2026/08/18/mdma-nda-resubmitted-fda-august-2026/)) ⟨daily 2026-09-06⟩
...
- **FDA finalized new psychedelic trial-design guidance** requiring active
  placebos, blinding questionnaires, expectancy controls, and paired
  placebo-controlled/no-placebo dose-response designs — the whole
...
- **A presidential executive order directed agencies to accelerate
  psychedelic drug review, and FDA issued "National Priority Vouchers"**
  to Compass Pathways (psilocybin/treatment-resistant depression), Usona
  Institute (psilocybin/MDD), and Transcend Therapeutics
...
- **COMP360 (psilocybin) hit its primary endpoint in a second Phase 3
  trial for treatment-resistant depression**, following the June 2025
...
- **COMP360's first Phase 3 trial (n=258, 25mg dose vs. placebo) delivered
  a statistically robust −3.6-point MADRS advantage over placebo
  (p<0.001)**, with 39% of high-dose responders reaching ≥25% MADRS
  reduction, rapid (next-day) onset, and durability out to 26 weeks —
...
- **FDA issued a Complete Response Letter to Lykos Therapeutics for
  MDMA-assisted therapy for PTSD** after its advisory committee voted 2-9
  against efficacy and 1-10 against benefit outweighing risk, citing
  functional unblinding and cardiovascular safety concerns. The CRL wasn't
