---
thread: hyperscaler-capex-big-picture
title: "Hyperscaler Capex"
lens: ai
entities: [google, meta-ai, amazon-aws, microsoft, nvidia]
opened: 2026-07-23
---

# Hyperscaler AI capex — the big picture — timeline

*Watch:* The combined ~$725B+ 2026 capex plan across Google/Meta/Amazon/
Microsoft and whether AI revenue is catching up to it — the aggregate
trend across all four sub-threads (google-capex, meta-capex, aws-capex,
...
- **JPMorgan chief executive Jamie Dimon said spending across the hyperscaler ecosystem has more than doubled from about $300 billion last year to around $700 billion this year and could reach $1 trillion next year.** Speaking to CNBC-TV18 at JPMorgan's India investor conference, he called the surge "like 1% increase to GDP each year" and warned it may also add to inflation. It bears directly on this thread's own tracked question of whether the ~$610-650bn combined 2026 plan across Google/Microsoft/Amazon/Meta is peaking — Dimon's figure covers the wider hyperscaler ecosystem, not just those four, and points the other way. The same quote is already logged on the sibling thread `chip-hyperscaler-rotation` (dated 09-21, staged 09-24); flagging here since it wasn't yet on this thread and speaks to this thread's specific watch question. ([CNBC](https://www.cnbc.com/2026/09/21/jamie-dimon-jpm-jpmorgan-indiaconference.html), [CNBC-TV18](https://www.cnbctv18.com/technology/ai/ai-capex-could-hit-1-trillion-next-year-says-jpmorgan-ceo-jamie-dimon-19995144.htm)) ⟨daily 2026-09-25⟩

## 2026-09-10 — Microsoft's own plan answers this thread's "pulling back" question: triple capacity by 2032, not shrink it

- **Bloomberg reported (09-10) that Microsoft plans to more than triple its global data-center capacity, from roughly 12 gigawatts today to more than 38 gigawatts by 2032** — including a guided doubling to roughly 24GW by mid-2028. Microsoft has not stated the figure in any filing, press release or earnings call, and did not respond to requests for comment, so this rests on Bloomberg's sourcing rather than a primary Microsoft document. AI-specific capacity is reported to grow from ~2GW of the current 12GW to roughly a third of the 38GW target. This sits directly against Microsoft's own disclosed numbers this thread already tracks: fiscal 2026 capex of ~$145B and $329.1B of signed-but-not-yet-commenced lease commitments as of 06-30-2026 (up from $196.6B the prior quarter) — both filed figures, unlike the 38GW target itself. **This is the clearest single-company answer yet to this thread's own watch line ("any hyperscaler actually pulling back")**: the reported plan is acceleration, not retrenchment, arriving fifteen days after this thread's 08-25 entry on the OpenAI data-center chief's exit and in the same week as Nvidia's raised top-five hyperscaler forecast (08-26 entry, ~$1.3T for 2027).
