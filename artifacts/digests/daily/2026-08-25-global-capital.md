...
either a preview of, or a fact positioned ahead of, Nvidia's Wednesday
Q2 print — the same convergence the frontier-ai page notes from the
supply side. This page carries the demand-side and price-side version of
the same story.

**Nvidia is in its longest losing streak since September 2022 — before
ChatGPT existed — and on the same day its own CEO admitted AI hasn't had
its breakout moment yet.** The stock closed Monday at $208.48, down
2.91%, its seventh straight decline, roughly 8% down over the run (a
materially smaller drop than 2022's 24% seven-day slide, but the same
shape of signal). On a podcast released the same day, Sam Altman said AI
has "not had the iPhone moment," comparing today's AI adoption to the
pre-iPhone Palm Treo era. Coming from OpenAI's own CEO rather than a
short-seller, that is a demand-side admission distinct from the
circular-financing mechanics this map tracks elsewhere.

**Nvidia is also reported doubling down on the financing side of the
loop.** The Information reports Nvidia is in talks for a new stake in
Perplexity AI at a valuation of more than $30bn — up 50% from roughly
$20bn a year ago — adding to a position it already holds alongside Jeff
Bezos and SoftBank. Same pattern this thread already tracks via
Poolside, SSI, Groq and Cloverleaf, one company further down the stack.

**Outside the Nvidia orbit, two threads moved on their own news.**
HUMAIN landed a new named partner — Mistral AI, in a deal described as
worth "hundreds of millions of Euros" — direct evidence that outside
demand, not only Saudi state capital, is filling its compute. And a
Houthi ballistic missile struck a Saudi VLCC off Yanbu the same day
China's Foreign Ministry gave its first on-record response to Monday's
Iran sanctions package, warning against disrupting its relationship with
Tehran.

## Capital in my markets

- **Nvidia closed its seventh straight losing session, its longest
  streak since September 2022, the same day its CEO said AI hasn't had
  its breakout moment** — the stock fell 2.91% to $208.48 on Monday,
  roughly 8% down over the run. Separately, on a podcast released the
  same day, Sam Altman said AI has "not had the iPhone moment,"
  comparing the current period to the pre-iPhone Palm Treo era — a
  demand-side admission distinct from this map's circular-financing
  tracking, from the industry's most bullish voice, the day before the
  earnings print investors are treating as the AI trade's stress test.
  ([24/7 Wall St.](https://247wallst.com/investing/2026/08/25/nvidia-notches-longest-losing-streak-since-2022-tomorrows-earnings-could-make-it-worse/), [9to5Mac](https://9to5mac.com/2026/08/25/ai-awaiting-its-iphone-moment-says-altman-needs-to-learn-key-apple-lesson/))
  <!-- k: t=ai-trade-bear-turn e=nvidia,openai axis=capital-in-my-markets sev=major -->

- **Nvidia is reportedly in talks for a second, larger stake in
  Perplexity AI** — a new investment at a valuation of more than $30bn,
  up 50% from roughly $20bn a year earlier, adding to a stake Nvidia
  already holds alongside Jeff Bezos and SoftBank. Neither company
  commented; deal size undisclosed. Same "buy customer loyalty" pattern
  this thread already tracks via Poolside, SSI, Groq and Cloverleaf.
  ([SiliconANGLE](https://siliconangle.com/2026/08/24/nvidia-reportedly-eyes-another-investment-in-perplexity-ai-at-a-30b-valuation/))
  <!-- k: t=nvidia-vendor-financing e=nvidia axis=capital-in-my-markets -->

- **HUMAIN lands a new named partner: Mistral AI, in a deal worth
  "hundreds of millions of Euros"** — covering AI infrastructure, model
  development (starting with cybersecurity and voice, plus frontier
  models optimized for Arabic), and a joint go-to-market push into
  regulated Saudi industries. Mistral will also explore using HUMAIN's
  own data-center infrastructure for its regional compute needs — a
  direct answer to whether HUMAIN's capacity is being filled by outside
  demand rather than only Saudi state money, the second consecutive data
  point against this thread's fiscal-squeeze thesis. ([Mistral
  AI](https://mistral.ai/news/mistral-x-humain/))
  <!-- k: t=pif-ai-buildout e= axis=capital-in-my-markets -->

- **A Houthi ballistic missile struck the Saudi-flagged VLCC *Amzan*
  roughly 63 nautical miles off Yanbu, and China gave its first on-record
  response to Monday's Iran sanctions package** — the tanker caught fire;
  crew reported safe. Separately, China's Foreign Ministry spokesperson
  Lin Jian warned that "economic warfare and maximum pressure will not
  help resolve the issue" and would "only further intensify tensions,"
  saying Beijing's relationship with Iran "should not be disrupted" by
  US pressure — the direct response from the buyer of roughly 90% of
  Iran's oil exports, per Bessent's own 08-24 framing. ([Bloomberg](https://www.bloomberg.com/news/articles/2026-08-24/yemen-s-houthi-rebels-attack-saudi-oil-supertanker-in-red-sea), [Bloomberg](https://www.bloomberg.com/news/articles/2026-08-25/china-defends-cooperation-with-iran-warns-against-disrupting-it-mt8dnid2))
  <!-- k: t=red-sea-oil-shock,iran-conflict-widening e= axis=capital-in-my-markets sev=major -->

- **Anthropic investors are reportedly targeting a $2 trillion-or-more
  IPO valuation** (cold-rotation catch, dated 08-17) — up from the $965bn
  Series H (May 2026) and $1.18 trillion priced on secondary markets as
  of August 6, continuing the valuation climb this thread tracks, though
  Fidelity's own position size isn't itemized in this reporting. ([The
...
- `project-camellia-community-panel-0826` — a community panel on
  OpenAI's Georgia data-center campus, tentatively 08-26 (routed to
  `ai-datacenter-sites`).
- `ercot-datacenter-audit-dec2026` — ERCOT's ordered audit of Texas
  data-center grid impact, due by end of 2026 (routed to
  `datacenter-power-grid`).
- `openai-anthropic-congress-safety-disclosure-0824` — a 29-signer House
  Democrat letter's response deadline, **already passed as of logging
  with no confirmed outcome found** (routed to
  `openai-agent-security-incident`).
- `fda-genai-device-comment-deadline-1019` — FDA public-comment close on
  its generative-AI medical-device discussion paper (routed to
  `ai-therapy-regulatory-reckoning`, mental-health).
- `meta-warner-csam-ads-response-0826` — Meta's deadline to respond to
  Sen. Warner's letter (routed to `meta-ai-csam-ads`, mental-health).

**Dated tests this week, all still standing:** 08-26 Lisa Cook removal
deadline · 08-26 Nvidia Q2 earnings · 08-27–29 Jackson Hole · 08-28
Warsh's first keynote as Fed chair · 08-31 `anthropic-public-s1-filing`.

## 🔄 Map changes

- **08-24 finalized on a three-lens coverage-critic pass** (see
  `coverage-log.md`). One miss folded into the 08-24 page after the fact
  — Matt Levine's "Who Should Control Anthropic?" column — routed to
  `frontier-lab-ipos`.
- **Timeline blocks written today:** `nvidia-vendor-financing` (the
...
- ⚠️ **Two `sources/benchmarks.yaml` access notes added from today's
  finalize:** Bloomberg Technology re-blocked after a 08-23 fix that
  didn't hold; Axios Pro Rata's reader-proxy technique confirmed
  same-day-only, not an archive.
...
map already tracks, and Morgan Stanley put the first outside number on
the Rubin ramp specifically — all previews of, or facts positioned
ahead of, Wednesday's print. Outside that orbit, HUMAIN landed a named
partner in Mistral AI, and a Houthi missile strike on a Saudi tanker
