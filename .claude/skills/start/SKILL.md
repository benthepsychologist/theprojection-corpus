<!-- kit: attention/start@2026-07-31.3 — canonical: /workspace/kestrel/library/skills/attention/start/SKILL.md.tmpl — edit the canonical copy and run /sync-kits, not this file. -->
