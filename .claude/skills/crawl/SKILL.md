<!-- kit: attention/crawl@2026-07-31.3 — canonical: /workspace/kestrel/library/skills/attention/crawl/SKILL.md.tmpl — edit the canonical copy and run /sync-kits, not this file. -->
