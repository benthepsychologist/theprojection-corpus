<!-- kit: attention/classify@2026-07-31.2 — canonical: /workspace/kestrel/library/skills/attention/classify/SKILL.md.tmpl — edit the canonical copy and run /sync-kits, not this file. -->
