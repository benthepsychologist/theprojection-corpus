<!-- kit: common/map@2026-08-04.1 — canonical: /workspace/kestrel/library/skills/common/map/SKILL.md.tmpl — edit the canonical copy and run /sync-kits, not this file. -->
